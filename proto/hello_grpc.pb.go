...
type SampleClient interface {
	Hi(ctx context.Context, in *WelcomeReq, opts ...grpc.CallOption) (*WelcomeRes, error)
}
...
func (c *sampleClient) Hi(ctx context.Context, in *WelcomeReq, opts ...grpc.CallOption) (*WelcomeRes, error) {
	out := new(WelcomeRes)
	err := c.cc.Invoke(ctx, "/proto.sample/Hi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SampleServer interface {
	Hi(context.Context, *WelcomeReq) (*WelcomeRes, error)
...
func (UnimplementedSampleServer) Hi(context.Context, *WelcomeReq) (*WelcomeRes, error) {
...
func _Sample_Hi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WelcomeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SampleServer).Hi(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.sample/Hi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServer).Hi(ctx, req.(*WelcomeReq))
	}
